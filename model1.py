...
param_dist = {
    'max_depth': [2, 3, 4, 5, 6],
    'eta': uniform(0.1, 0.8),  # Uniform distribution for eta between 0.1 and 0.9
    'subsample': uniform(0.1, 0.9),  # Uniform distribution for subsample between 0.1 and 1.0
    'colsample_bytree': uniform(0.1, 0.9),  # Uniform distribution for colsample_bytree between 0.1 and 1.0
...
random_search = RandomizedSearchCV(estimator=xgb_model, param_distributions=param_dist, scoring=rmse_scorer, cv=2, n_iter=80, verbose=1, n_jobs=-1, random_state=42)
